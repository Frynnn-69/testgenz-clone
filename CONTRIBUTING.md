...
Menggunakan nama yang konsisten sangat membantu kita semua.
...
* `docs: memperbarui panduan kontribusi`

#### **C. Judul Pull Request (PR)**

Gunakan format: **`[KATEGORI] Deskripsi Fitur yang Dikerjakan`**

**Contoh Judul PR:**
* `[FE] Membuat Komponen Halaman Login`
* `[BE] Menambahkan API Endpoint untuk Registrasi User`
* `[DB] Membuat Skema untuk Tabel User dan Test`
