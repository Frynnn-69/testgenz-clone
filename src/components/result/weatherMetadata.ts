...
export const WEATHER_METADATA: Record<string, WeatherTypeMetadata> = {
  sunny: {
    ...
    description:
      "Sunny adalah pribadi yang ceria, optimis, dan mudah bergaul. Mereka memiliki energi yang tinggi dan mampu membawa suasana positif ke lingkungan sekitar.",
    colorScheme: "orange",
  ...
  rainy: {
    ...
    description:
      "Rainy adalah pribadi analitis yang menghargai detail dan ketelitian. Mereka cenderung perfeksionis dan memiliki standar tinggi dalam pekerjaan.",
    colorScheme: "blue",
  ...
  stormy: {
    ...
    description:
      "Stormy adalah pribadi yang tegas, ambisius, dan berorientasi hasil. Mereka memiliki kemampuan kepemimpinan alami dan tidak takut mengambil keputusan.",
    colorScheme: "purple",
  ...
  cloudy: {
    ...
    description:
      "Cloudy adalah pribadi yang tenang, sabar, dan mudah beradaptasi. Mereka adalah pendengar yang baik dan mampu menjadi mediator dalam konflik.",
    colorScheme: "gray",
 ...
 */
export function getWeatherMetadata(
  weatherType: string,
): WeatherTypeMetadata | undefined {
